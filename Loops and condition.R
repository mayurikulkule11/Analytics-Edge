...
# Create fruit vector
fruit <- c('Apple', 'Orange', 'Passion fruit', 'Banana' , 'Grapes')
...
# Create a matrix
mat <- matrix(data = seq(1, 18, by=2), nrow = 6, ncol =3)
mat
...
fruit <- list(Basket = c('Apple','Orange','Passion-fruit','Banana','Grapes'), 
              Money = c(10, 12, 15,20), purchase = TRUE)
